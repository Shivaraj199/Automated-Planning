...
int main(void)
{
	...
	/** SOLVING THE PROBLEM WITH THE DELETE RELAXATION HEURISTIC **/

	path p = astar(prob, delete_relaxation);

	for (std::vector<symbol> actions : std::get<1>(p))
	{
